...
export default class History extends Component {
  ...
  handleStartDate = date => {
    ...
    if (date <= endDate) {
      ...
      Alert.alert(
        'Date From',
        'Select date filter correctly. Date From should be smaller then Date To.',
        [
          {
            text: 'OK',
            onPress: () => this.setState({isVisibleStartDatePicker: false}),
          },
        ],
      );
    }
  ...
  handleEndDate = date => {
    ...
    if (startDate <= date) {
      ...
      Alert.alert(
        'Date To',
        'Select date filter correctly. Date To should be greater then Date From.',
        [
          {
            text: 'OK',
            onPress: () => this.setState({isVisibleEndDatePicker: false}),
          },
        ],
      );
    }
...
if(item.location == selectedLoc)
{
  ...
  getLocation() {
    ...
    getLocation(baseURLApp, mobileAPIToken, companyID).then(res => {
    ...
    <View
      ...
      <View
        ...
        <View style={{flex: 1, flexDirection: 'column'}}>
          ...
          <Text style={{color: '#820727', fontSize: 14, marginRight: 10}}>
            {item.location}
          </Text>
        </View>
    ...
    return (
      <Container
        ...
        <Header
          ...
          <Left style={{flex: 1}}>
            <Button
              ...
              <Icon name="menu-outline" style={styles.iconMenuTopDash} />
            </Button>
          </Left>
          <Body
            style={{
        ...
        <View style={styles.filterBackground}>
          <View style={{flexDirection: 'row'}}>
            <View style={styles.dateLeft}>
              <TouchableOpacity
                ...
                <Text style={styles.filterDateText}>
                  {moment(this.state.startDate, 'DD/MM/YYYY').format(
                    'DD MMM, YYYY',
                  )}
                </Text>
              </TouchableOpacity>
              ...
              <View style={{flexDirection: 'column', alignItems: 'center'}}>
                ...
                <FontAwesome
                  name={'calendar'}
                  size={20}
                  style={styles.historyIconsMiddle}
                />
                <Text style={styles.historyDivider}>|</Text>
              </View>
            </View>
            ...
            <View style={styles.dateRight}>
              <TouchableOpacity
                ...
                <Text style={[styles.filterLabelDate, {marginLeft: 4}]}>
                  To Date
                </Text>
                <Text style={[styles.filterDateText, {marginLeft: 4}]}>
                  {moment(this.state.endDate, 'DD/MM/YYYY').format(
                    'DD MMM, YYYY',
                  )}
                </Text>
              </TouchableOpacity>
          ...
          {this.state.showLocFilter &&
            this.state.dataLocation != null &&
            ...
            <ListView
              ...
              renderRow={(rowData, index) => (
                <Card
                  ...
                  key={rowData.punchDate}>
                  <CardItem
                    key={rowData.employeePunchTime}
                    style={{
                      paddingRight: 0,
