...
export default class PunchIn extends Component {
  ...
  savePunch() {
    ...
    if (
      ...
      let date =
        ...
        '-' +
        parseInt(dateSelected.getMonth() + 1) +
        '-' +
  ...
  handleDate = date => {
    this.setState({selectedDate: date, isVisibleDatePicker: false});
  };
        ...
        />
          ...
          <View style={styles.boxLayout}>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.TextPunchRequest}>
