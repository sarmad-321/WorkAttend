...
export default class OnboardingScreens extends Component {
  ...
  navigateDashboard() {
    ...
    //   index: 0,
    //   actions: [NavigationAction.navigate({routeName: 'CompanyRegister'})],
    // });
    const navigateAction = CommonActions.reset({
      index: 0,
      routes: [{name: 'CompanyRegister'}],
    });
...
const styles = StyleSheet.create({
  ...
  // Pagination dot
  dot: {
    backgroundColor: '#fff', //"rgba(0,0,0,.75)",
    width: 8,
    height: 8,
    borderRadius: 4,
    marginLeft: 3,
  ...
  // Active dot
  activeDot: {
    backgroundColor: 'rgba(243,29,84,1)',
  },
  // Button wrapper
  buttonWrapper: {
    backgroundColor: 'transparent',
